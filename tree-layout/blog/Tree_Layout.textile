...
To illustratep the Sirius' layout capabilities imagine that we want to visualize the hierarchy of characters in the US TV series "House Of Cards":http://en.wikipedia.org/wiki/House_of_Cards_(U.S._TV_series). To do  this we define the following metamodel:

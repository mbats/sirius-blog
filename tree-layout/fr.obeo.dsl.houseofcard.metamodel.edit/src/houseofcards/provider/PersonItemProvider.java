...
/**
 * This is the item provider adapter for a {@link houseofcards.Person} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PersonItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addInfluencesPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Person_dependsOn_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Person_dependsOn_feature", "_UI_Person_type"),
				 HouseofcardsPackage.Literals.PERSON__DEPENDS_ON,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 HouseofcardsPackage.Literals.PERSON__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Influences feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addInfluencesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Person_influences_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Person_influences_feature", "_UI_Person_type"),
				 HouseofcardsPackage.Literals.PERSON__INFLUENCES,
				 true,
				 false,
				 true,
				 null,
	...
	public ResourceLocator getResourceLocator() {
		return HouseofcardsEditPlugin.INSTANCE;
	}

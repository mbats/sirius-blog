...
/**
 * This is the item provider adapter for a {@link fr.obeo.starwars.dsl.starwars.Person} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StarwarsPackage.Literals.PERSON__NAME,
				 true,
				 false,
				 false,
	...
	protected void addDarkPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Person_dark_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Person_dark_feature", "_UI_Person_type"),
				 StarwarsPackage.Literals.PERSON__DARK,
				 true,
				 false,
				 false,

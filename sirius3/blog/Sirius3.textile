...
The goal was to get a runtime which react well with 1 million elements. Why one million? Because it is a beautiful number... but also because we noted that the modelization environments are fastly growing to 200K elements and 500K in case of in-depth analysis. Usually when you are over 500K, it means: "think about reorganizing your stuff". That is why we aim Sirius to work with 1 millions, then it will be really smoothly with the more usual 500K use case. 

...
To fix this problem, Sirius supports the SVG images. A Scalable girl SVG image is created thanks to an appropriate vector graphics editor like "Inkscape":https://inkscape.org/en/.
